...
const Sidebar = ({ setActiveTab }) => {
  ...
  return (
    <div>
      ...
      <div className="lg:hidden bg-gradient-to-r from-indigo-800 to-black p-4">
      ...
      {/* Sidebar */}
      <div
        className={`lg:w-72 w-full bg-gradient-to-b from-indigo-800 to-black text-white flex flex-col p-4 transition-transform ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'
      ...
      >
        ...
        <nav className="flex flex-col space-y-2">
          <button
            className="flex items-center gap-4 px-4 py-3 rounded-lg hover:bg-indigo-700 transition-colors"
